        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <span class="text-2xl font-bold text-red-600">California</span>
                        <span class="text-xl font-semibold text-gray-700">Fitness</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-gray-700 hover:text-red-600 transition-colors">Login</a>
                        <a href="{{ route('register') }}" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors">Join Now</a>
                    </div>
                @endauth
            </div>
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                <div class="px-4 space-y-2">
                    ...
                    <x-responsive-nav-link :href="route('register')" class="inline-block bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors">
                        {{ __('Join Now') }}
                    </x-responsive-nav-link>
                </div>
            </div>
